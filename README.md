...
Для автоматической установки всех зависимостей, пакетов системы, настройки виртуального окружения и конфигурации `.env` на чистом сервере Ubuntu/Debian выполните команду:

```bash
wget -qO- https://raw.githubusercontent.com/justik13/amneziatgbot/main/deploy.sh | bash
```
